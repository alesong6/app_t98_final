...
<head>
    ...
    <link rel="stylesheet" href="public/css/themes/splide-default.min.css">

    <link rel="stylesheet" href="public/css/styles.css">

    <script src="public/js/splide.min.js" defer></script>
    <script src="public/js/comportamentos.js" defer></script>
    ...
    <header>
        ...
        <nav>
            <ul>
                ...
                <li>
                    <a id="sistema" href="sistema.html">Sistema</a>
